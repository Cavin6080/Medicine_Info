...
class MedicinesData {
  static const List<Medicine> medicineMenu = [
    Medicine(
      id: 1,
    ...
    Medicine(
      ...
      description:
          'The Best Chocolate Cake Medicine – A one bowl chocolate cake Medicine that is quick, easy, and delicious! Updated with gluten-free, dairy-free, and egg-free options!',
      ingredients: [
        '',
      ],
      instructions: [
    ...
    Medicine(
      ...
      title: 'Apple Pie',
      description:
          "This was my grandmother's apple pie Medicine. I have never seen another one quite like it. It will always be my favorite and has won me several first place prizes in local competitions.",
      ingredients: [
        '',
      ],
      instructions: [
